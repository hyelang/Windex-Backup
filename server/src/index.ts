...
app.use(
    cors({
        origin: [
            ...
            'http://18.183.39.40:3000',
            'http://52.192.246.169:3000',
            'http://windex.efforthye.com:3000',
            'https://windex.efforthye.com',
        ],
        credentials: true,
    })
);
...
app.listen(app.get('port') || 8080, async () => {
    await connect(process.env.EPSILON_DATABASE_IP || '3.34.215.52' || '127.0.0.1');
    console.log(`${app.get('port') || 8080} port server open`);
});
