...
const UserList = () => {
    const postUserList = async () => {
        try {
            const data = await axios.post('https://server.efforthye.com/api/user/findUserList', '무엇이 필요하니?');
            return data.data;
        } catch (error) {
            console.log(error);
        }
    ...
    const fetchUserList = async () => {
        try {
            const data = await axios.get('https://server.efforthye.com/api/user/userList?type=all');
            return data.data;
        } catch (error) {
            console.log(error);
        }
